...
def cal_alpha_opt_post(samp1,samp2,m1_train,m2_train, l_w_max, l_yw_max,lst_var,lst_a,lst_x,lst_z,lst_w,lst_y, scale_mx=10,scale_mn=.5,int_lst=[], optimise_l_yw=False,optimise_l_w=False, l_yw_min=0.01,l_w_min=.01):     
        ...
        '''
        # This is a modified implemenation of eq 55 and 56 in Appendix B of 'Proximal Causal Learning with Kernels: Two-Stage Estimation and Moment Restriction'
        #https://arxiv.org/pdf/2105.04544.pdf. We learned that this implementation offers memory efficiency and it is faster than original emplimentation. 
